...
<div class="page-container">
    <div class="page-header">
        ...
        <div style="display:flex;gap:8px;">
            ...
            <a href="{{ route('monitoring.download', $monitoring->id) }}" class="btn-back" style="background:#27ae60;color:#fff;">Download PDF</a>
        </div>
    </div>
    ...
    <div class="field">
        ...
        <div class="value">{{ $monitoring->created_at ? \Carbon\Carbon::parse($monitoring->created_at)->setTimezone('Asia/Jakarta')->format('d/m/Y H:i') : '-' }}</div>
    </div>
